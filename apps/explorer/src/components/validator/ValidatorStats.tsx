			...
			<div className="flex-grow">
				<div className="flex basis-full flex-col gap-5 md:basis-1/3">
					...
					<div className="grid grid-cols-2">
						...
						<Stats
							label="Total BFC Staked"
							tooltip="The total BFC staked on the network by validators and delegators to validate the network and earn rewards."
					...
					<div className="flex flex-col gap-5">
						...
						<div className="grid grid-cols-2">
							...
							<Stats
								...
								tooltip="A score generated by validators to evaluate each other’s performance throughout BFC’s regular operations."
