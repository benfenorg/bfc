...
| --------------- | ------------------ | ----------------------------------- |
| Ed25519         | `Ed25519Keypair`   | `@benfen/bfc.js/keypairs/ed25519`   |
| ECDSA Secp256k1 | `Secp256k1Keypair` | `@benfen/bfc.js/keypairs/secp256k1` |
| ECDSA Secp256r1 | `Secp256r1Keypair` | `@benfen/bfc.js/keypairs/secp256r1` |
...
To use, import the key pair class your project uses from the `@benfen/bfc.js/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@benfen/bfc.js/keypairs/ed25519`.
...
```typescript
import { Ed25519Keypair, Ed25519PublicKey } from '@benfen/bfc.js/keypairs/ed25519';
...
```typescript
import { Ed25519Keypair } from '@benfen/bfc.js/keypairs/ed25519';
import { verifyPersonalMessage } from '@benfen/bfc.js/verify';
...
<<<<<<< HEAD
import { Ed25519Keypair } from '@benfen/bfc.js/keypairs/ed25519';
import { verifyTransactionBlock } from '@benfen/bfc.js/verify';
