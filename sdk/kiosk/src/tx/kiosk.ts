...
/**
 * Call the `kiosk::purchase<T>(Kiosk, ID, Coin<BFC>)` function and receive an Item and
...
/**
 * Call the `kiosk::withdraw(Kiosk, KioskOwnerCap, Option<u64>)` function and receive a Coin<BFC>.
