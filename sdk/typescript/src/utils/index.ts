...
import { formatAddress, formatDigest, sui2ObcAddress } from './format.js';
import {
	isValidSuiAddress,
	isValidSuiObjectId,
...
export const SUI_SYSTEM_MODULE_NAME = 'obc_system';
export const SUI_TYPE_ARG = `${SUI_FRAMEWORK_ADDRESS}::obc::OBC`;
export const SUI_SYSTEM_STATE_OBJECT_ID: string = sui2ObcAddress('0x5');
