...
export function GettingStarted() {
	return (
		<div className={styles.container}>
			<Heading as="h2">Get Started with Bfc</Heading>
			<div className={styles.content}>
				<InfoSection title="Install the Benfen Wallet Extension">
					We recommend pinning Benfen Wallet to your taskbar for quicker access.
				</InfoSection>
				...
				<div className={styles.installButtonContainer}>
					<Button variant="outline" asChild>
						<a
							href="https://chromewebstore.google.com/detail/openblock-bridge/memiokcjdencbponfgbkojkenpdpejhj"
							target="_blank"
							rel="noreferrer"
						>
