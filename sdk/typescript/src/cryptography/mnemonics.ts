...
/**
 * Parse and validate a path that is compliant to BIP-32 in form m/54'/728'/{account_index}'/{change_index}/{address_index}
 * for Secp256k1 and m/74'/728'/{account_index}'/{change_index}/{address_index} for Secp256r1.
 *
