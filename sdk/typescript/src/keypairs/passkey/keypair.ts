...
import { toBase64 } from '../../bcs/index.js';
	...
	async create(): Promise<RegistrationCredential> {
		return (await navigator.credentials.create({
			publicKey: {
				...
				challenge: new TextEncoder().encode('Create passkey wallet on Benfen'),
...
export class PasskeyKeypair extends Signer {
	 ...
	 * ```
	 * let provider = new BrowserPasskeyProvider('Benfen Passkey Example',{
	 * 	  rpName: 'Benfen Passkey Example',
