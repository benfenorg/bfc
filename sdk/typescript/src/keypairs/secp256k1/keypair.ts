...
export const DEFAULT_SECP256K1_DERIVATION_PATH = "m/54'/728'/0'/0/0";
...
export class Secp256k1Keypair extends Keypair {
	...
	static fromSecretKey(
		...
		if (typeof secretKey === 'string') {
			const decoded = decodeBenfenPrivateKey(secretKey);
	 ...
	 *
	 * If path is none, it will default to m/54'/728'/0'/0/0, otherwise the path must
	 * be compliant to BIP-32 in form m/54'/728'/{account_index}'/{change_index}/{address_index}.
	 */
