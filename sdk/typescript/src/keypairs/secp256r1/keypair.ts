...
export const DEFAULT_SECP256R1_DERIVATION_PATH = "m/74'/728'/0'/0/0";
...
export class Secp256r1Keypair extends Keypair {
	 ...
	 *
	 * If path is none, it will default to m/74'/728'/0'/0/0, otherwise the path must
	 * be compliant to BIP-32 in form m/74'/728'/{account_index}'/{change_index}/{address_index}.
	 */
