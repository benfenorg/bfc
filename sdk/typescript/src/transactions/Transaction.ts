...
import { fromBase64, isSerializedBcs } from '../bcs/index.js';
...
const TRANSACTION_BRAND = Symbol.for('@benfen/transaction') as never;
				...
				: this.#data.addInput(
						...
						typeof value === 'string'
							? {
									...
									UnresolvedObject: { objectId: normalizeHexAddress(value) },
								}
							: value,
					);
		},
