...
import type { BenfenClient, CoinStruct } from '../../client/index.js';
import { normalizeStructTag } from '../../utils/bf-types.js';
...
const BFC_TYPE = normalizeStructTag('0x2::bfc::BFC');
	...
	return (tx: Transaction) => {
		...
		return tx.add(
			Commands.Intent({
				...
				inputs: {},
				data: {
					type: coinType === BFC_TYPE && useGasCoin ? 'gas' : coinType,
