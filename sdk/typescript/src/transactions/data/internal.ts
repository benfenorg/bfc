...
import type { EnumInputShape, EnumOutputShape } from '../../bcs/index.js';
import { isValidBenfenAddress, normalizeHexAddress } from '../../utils/bf-types.js';
...
export const BenfenAddress = pipe(
	string(),
	transform((value) => normalizeHexAddress(value)),
	check(isValidBenfenAddress),
);
export const ObjectID = BenfenAddress;
