...
describe('String type guards', () => {
	...
	describe('isValidSuiAddress() / isValidObjectID()', () => {
		...
		it('accepts hex strings of the correct length, and 0x prefix', () => {
			expectAll(
				[
					'0x0000000000000000000000009edd26f2ef1c1796f9feaa703c8628e5a70618c8',
					'0x0000000000000000000000005f713bef531629b47dd1bdbb382acec5224fc9ab',
