...
describe('Keypair', () => {
	...
	it('`toHexAddress()` should return a valid benfen address', async () => {
		expect(k1.toHexAddress()).toEqual(pk1.toHexAddress());
		expect(k1.toHexAddress()).toEqual(
			'0xafedf3bc60bd296aa6830d7c48ca44e0f7a32478ae4bd7b9a6ac1dc81ff7b29b',
		);

		expect(k2.toHexAddress()).toEqual(pk2.toHexAddress());
		expect(k2.toHexAddress()).toEqual(
			'0x7e4f9a35bf3b5383802d990956d6f3c93e6184ebbbcf0820c124ab3a59ef77ac',
		);

		expect(k3.toHexAddress()).toEqual(pk3.toHexAddress());
