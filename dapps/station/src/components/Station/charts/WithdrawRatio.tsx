	...
	return (
		<div className="bg-white text-bf-text1 rounded-lg">
			<div className="flex items-center py-2 px-5 border-b border-bf-border">
				<div className="flex">
					<BusdCoinIcon className="w-[20px]" />
					<BfcCoinIcon className="w-[20px] ml-[-2px]" />
				</div>
				<div className="ml-1 font-semibold">13 BUSD = 1 BFC</div>
				<div className="ml-1 text-xs text-bf-text2">赎回比例</div>
			</div>
			<div className="p-5">
