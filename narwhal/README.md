...
This directory provides an implementation of [Narwhal](https://arxiv.org/pdf/2105.11827.pdf) 
...
efficient [BFT](https://en.wikipedia.org/wiki/Byzantine_fault) consensus. 
The codebase has been designed to be small, efficient, and easy to benchmark and modify. 
