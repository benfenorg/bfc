...
module conventions::wallet {
  ...
  public fun destroy_empty(self: Wallet<Balance<BFC>>) {
...
module conventions::access_control {
  ...
  public fun withdraw(state: &mut State, account: &mut Account, ctx: &mut TxContext): Coin<BFC> {
  ...
  public fun wrong_withdraw(state: &mut State, ctx: &mut TxContext): Coin<BFC> {
...
module conventions::vesting_wallet {
  ...
  */
  public fun new(deposit: Coin<BFC>, ctx: &mut TxContext): OwnedWallet {
    // Implementation omitted.
    abort(0)
  }
  ...
  */
  public fun new_shared(deposit: Coin<BFC>, ctx: &mut TxContext) {
    // Implementation omitted.
