...
use crate::{
    ...
    sui_mode::{
        ...
        OBJECT_NEW_UID_FROM_HASH, RANDOMNESS_MODULE_NAME, RANDOMNESS_STATE_CREATE,  ANONYMOUS_MODULE_NAME, ANONYMOUS_STATE_CREATE,
        SUI_ADDR_NAME, SUI_ADDR_VALUE, SUI_CLOCK_CREATE, SUI_SYSTEM_ADDR_VALUE, SUI_SYSTEM_CREATE,
        SUI_SYSTEM_MODULE_NAME, TEST_SCENARIO_MODULE_NAME, TS_NEW_OBJECT, UID_TYPE_NAME, BFC_SYSTEM_ADDR_VALUE
    },
};
...
pub const FUNCTIONS_TO_SKIP: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (BFC_SYSTEM_ADDR_VALUE, BFC_SYSTEM_MODULE_NAME, BFC_SYSTEM_CREATE),
    (
        SUI_ADDR_VALUE,
    ...
    (SUI_ADDR_VALUE, ANONYMOUS_MODULE_NAME, ANONYMOUS_STATE_CREATE),
];
