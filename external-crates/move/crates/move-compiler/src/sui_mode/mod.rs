...
pub const BRUB_MODULE_NAME: Symbol = symbol!("brub");
pub const BCAD_MODULE_NAME: Symbol = symbol!("bcad");
pub const BUSD_MODULE_NAME: Symbol = symbol!("busd");
pub const BZAR_MODULE_NAME: Symbol = symbol!("bzar");
pub const BINR_MODULE_NAME: Symbol = symbol!("binr");
pub const BSAR_MODULE_NAME: Symbol = symbol!("bsar");
pub const BJPY_MODULE_NAME: Symbol = symbol!("bjpy");
pub const BIDR_MODULE_NAME: Symbol = symbol!("bidr");
pub const BMXN_MODULE_NAME: Symbol = symbol!("bmxn");
pub const BBRL_MODULE_NAME: Symbol = symbol!("bbrl");
pub const MGG_MODULE_NAME: Symbol = symbol!("mgg");
pub const BGBP_MODULE_NAME: Symbol = symbol!("bgbp");
pub const BTRY_MODULE_NAME: Symbol = symbol!("btry");
pub const BAUD_MODULE_NAME: Symbol = symbol!("baud");
