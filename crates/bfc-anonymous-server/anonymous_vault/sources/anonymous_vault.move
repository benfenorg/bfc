...
const ADMIN_MAX_COUNT: u64 = 3;
const THRESHOLD_FOR_ACTION: u64 = 2;
...
entry fun deposit_upgrade_cap_to_vault( obj: UpgradeCap, object_key: string::String,  vault: &mut AnonymousVault, ctx: &TxContext){
