...
mod tests {
    ...
    fn test_bridge_action_path_regression_tests() {
        ...
        assert_eq!(
            BridgeClient::bridge_action_to_path(&action),
            "sign/add_tokens_on_evm/12/0/1/99,100,101/0x0101010101010101010101010101010101010101,0x0202020202020202020202020202020202020202,0x0303030303030303030303030303030303030303/5,6,7/5,6,7/1000000000,2000000000,3000000000",
        );
