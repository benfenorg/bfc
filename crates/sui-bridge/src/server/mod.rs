...
pub const BSC_TO_SUI_TX_PATH: &str = "/sign/bridge_tx/:chain_id/sui/:tx_hash/:event_index";
...
pub(crate) fn make_router(
    ...
    Router::new()
        ...
        .route(BSC_TO_SUI_TX_PATH, get(handle_bsc_tx_hash))
