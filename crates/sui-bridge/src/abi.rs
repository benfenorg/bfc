    ...
    fn test_eth_message_conversion_add_tokens_on_evm_action_regression() -> anyhow::Result<()> {
        ...
        assert_eq!(
            ...
            eth_bridge_config::Message {
                ...
                payload: Hex::decode("0x010300000000000000630000000000000064000000000000006503010101010101010101010101010101010101010102020202020202020202020202020202020202020303030303030303030303030303030303030303030506070305060703000000003b9aca00000000007735940000000000b2d05e00").unwrap().into(),
            }
        );
        Ok(())
    }
