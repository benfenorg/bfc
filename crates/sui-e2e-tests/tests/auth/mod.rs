...
pub async fn auth_setup(test_cluster: &mut TestCluster, http_client: &mut HttpClient, address: SuiAddress, bfc_status_address: &SuiAddress, auth_key: &str) -> Result<(), Error> {
    let args0 = vec![
