...
//> test::m1::t1<sui::coin::Coin<sui::bfc::BFC>>(Gas)

//# programmable --sender A
//> test::m1::t2<sui::coin::Coin<sui::bfc::BFC>>(Gas)

//# programmable --sender A
//> test::m1::t2<sui::coin::Coin<sui::bfc::BFC>>(Gas)

//# programmable --sender A
//> test::m1::t4<sui::coin::Coin<sui::bfc::BFC>>(Gas)

//# programmable --sender A
//> test::m1::t5<sui::coin::Coin<sui::bfc::BFC>>(Gas)

//# programmable --sender A
//> test::m1::t6<sui::coin::Coin<sui::bfc::BFC>>(Gas)
