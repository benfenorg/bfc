...
module test::m1 {
    ...
    public fun transfer(v: vector<coin::Coin<sui::obc::OBC>>, r: address) {
...
//# run sui::pay::split_and_transfer --type-args sui::obc::OBC --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<sui::coin::Coin<sui::obc::OBC>>([NestedResult(1,0), NestedResult(1,1)]);
