...
pub fn convert_from_transmission_shares(
    ...
    let value = recover_from_transmission_shares(transmission_hex1, transmission_hex2, mask_secret)?;
...
mod tests {
    ...
    fn test_convert_from_transmission_shares() {
        ...
        let (hex1, hex2) = mpc_transmission::two_party_share::split_to_two_value(original_value, TEST_USER_ID, TEST_MASK_SECRET);
    ...
    fn test_convert_different_user_ids() {
        ...
        for &user_id in &user_ids {
            let (hex1, hex2) = mpc_transmission::two_party_share::split_to_two_value(original_value, user_id, TEST_MASK_SECRET);
            let (core_hex1, core_hex2, seed) = convert_from_transmission_shares(
                &hex1,
                &hex2,
                TEST_MASK_SECRET,
    ...
    fn test_convert_different_coord_seeds() {
        ...
        for &coord_seed in &coord_seeds {
            ...
            assert_eq!(value, original_value, "Failed for coord_seed: {}", coord_seed);
    ...
    fn test_convert_different_mask_secrets() {
        ...
        for &mask_secret in &mask_secrets {
            let (hex1, hex2) = mpc_transmission::two_party_share::split_to_two_value(original_value, TEST_USER_ID, mask_secret);
            let (core_hex1, core_hex2, seed) = convert_from_transmission_shares(
                &hex1,
                &hex2,
                mask_secret,
            ...
            assert_eq!(value, original_value, "Failed for mask_secret: {}", mask_secret);
            assert_eq!(seed, TEST_COORD_SEED);
        }
    }
    ...
    fn test_convert_multiple_values() {
        ...
        for original_value in test_values {
            ...
            assert_eq!(value, original_value, "Failed for value: {}", original_value);
            assert_eq!(seed, TEST_COORD_SEED);
        }
    }
    ...
    fn test_convert_mismatched_shares() {
        ...
        let value1 = 11111;
        let value2 = 22222;
        let (hex1_1, _hex2_1) = mpc_transmission::two_party_share::split_to_two_value(value1, TEST_USER_ID, TEST_MASK_SECRET);
        let (hex1_2, _hex2_2) = mpc_transmission::two_party_share::split_to_two_value(value2, TEST_USER_ID, TEST_MASK_SECRET);
        ...
        if let Ok((core_hex1, core_hex2, _)) = result {
            let recovered = crate::two_party_share::recover_value(
                core_hex1,
                core_hex2,
                TEST_MASK_SECRET,
            ).unwrap();
