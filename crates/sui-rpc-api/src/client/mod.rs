...
fn certified_checkpoint_internal_summary_try_from_proto(
    ...
    let summary_result: Result<sui_sdk_types::CheckpointSummary,  bcs::Error>   = summary_bcs
...
fn checkpoint_data_try_from_proto(
    ...
    let checkpoint_summary = certified_checkpoint_internal_summary_try_from_proto(summary_bcs, signature)?;
