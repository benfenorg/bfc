...
use crate::committee::ObcRoundId;
...
pub enum CertificateProof {
    ...
    RoundID(ObcRoundId,EpochId, CheckpointSequenceNumber),
}
...
impl CertificateProof {
    ...
    pub fn new_round_from_checkpoint(round:ObcRoundId,epoch: EpochId, checkpoint: CheckpointSequenceNumber) -> Self {
        Self::RoundID(round,epoch,checkpoint)
    }
