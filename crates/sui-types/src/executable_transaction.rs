...
use crate::committee::BfcRoundId;
...
pub enum CertificateProof {
    ...
    RoundID(BfcRoundId, EpochId, CheckpointSequenceNumber),
}
...
impl CertificateProof {
    ...
    pub fn new_round_from_checkpoint(round: BfcRoundId, epoch: EpochId, checkpoint: CheckpointSequenceNumber) -> Self {
