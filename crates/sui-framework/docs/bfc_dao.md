...
<pre><code><b>invariant</b> voting_quorum_rate &gt; 0 && <a href="bfc_dao.md#0xc8_bfc_dao_voting_quorum_rate">voting_quorum_rate</a> &lt;= 100;
...
<dt>
<code>proposal_record: <a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, <a href="bfc_dao.md#0xc8_bfc_dao_ProposalInfo">bfc_dao::ProposalInfo</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>action_record: <a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, <a href="bfc_dao.md#0xc8_bfc_dao_BFCDaoAction">bfc_dao::BFCDaoAction</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>current_proposal_status: <a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, <a href="bfc_dao.md#0xc8_bfc_dao_ProposalStatus">bfc_dao::ProposalStatus</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_getProposalRecord">getProposalRecord</a>(dao : &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>) :VecMap&lt;u64, <a href="bfc_dao.md#0xc8_bfc_dao_ProposalInfo">ProposalInfo</a>&gt;{
    dao.proposal_record
}
</code></pre>
...
<a name="0xc8_bfc_dao_NewDaoConfigParamSchema"></a>


<pre><code><b>schema</b> <a href="bfc_dao.md#0xc8_bfc_dao_NewDaoConfigParamSchema">NewDaoConfigParamSchema</a> {
    voting_delay: u64;
    voting_period: u64;
    voting_quorum_rate: u8;
    min_action_delay: u64;
    <b>aborts_if</b> voting_delay &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_TIME_PERIOD">MAX_TIME_PERIOD</a> || voting_delay == 0;
    <b>aborts_if</b> voting_period &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_TIME_PERIOD">MAX_TIME_PERIOD</a> || voting_period == 0 ;
    <b>aborts_if</b> voting_quorum_rate == 0 || voting_quorum_rate &gt; 100;
    <b>aborts_if</b> min_action_delay &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_TIME_PERIOD">MAX_TIME_PERIOD</a> || min_action_delay == 0;
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_get_bfcdao_actionid">get_bfcdao_actionid</a>(bfcDaoAction: <a href="bfc_dao.md#0xc8_bfc_dao_BFCDaoAction">BFCDaoAction</a>): u64 {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_create_bfcdao_action">create_bfcdao_action</a>(
    ...
    <b>let</b> size=<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_size">vec_map::size</a>(&dao.action_record);
    ...
    <b>assert</b>!(<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&dao.action_record, &action_id) == <b>false</b>, <a href="bfc_dao.md#0xc8_bfc_dao_ERR_ACTION_ID_ALREADY_INDAO">ERR_ACTION_ID_ALREADY_INDAO</a>);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_create_dao">create_dao</a>(
    ...
    <b>assert</b>!( <a href="_length">vector::length</a>(&admins) &lt;= <a href="bfc_dao.md#0xc8_bfc_dao_MAX_ADMIN_COUNT">MAX_ADMIN_COUNT</a>, <a href="bfc_dao.md#0xc8_bfc_dao_ERR_CONFIG_PARAM_INVALID">ERR_CONFIG_PARAM_INVALID</a> );
    <b>assert</b>!( <a href="_length">vector::length</a>(&admins) &gt; 0, <a href="bfc_dao.md#0xc8_bfc_dao_ERR_CONFIG_PARAM_INVALID">ERR_CONFIG_PARAM_INVALID</a> );
...
<b>aborts_if</b> <a href="_length">vector::length</a>(admins) &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_ADMIN_COUNT">MAX_ADMIN_COUNT</a> || <a href="_length">vector::length</a>(admins) == 0;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_remove_action">remove_action</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,_: &BFCDaoManageKey, actionId: u64){
    <b>let</b> size=<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_size">vec_map::size</a>(&dao.action_record);
    ...
    <b>assert</b>!(<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>&lt;u64,<a href="bfc_dao.md#0xc8_bfc_dao_BFCDaoAction">BFCDaoAction</a>&gt;(&dao.action_record,&actionId),<a href="bfc_dao.md#0xc8_bfc_dao_ERR_ACTION_ID_NOT_EXIST">ERR_ACTION_ID_NOT_EXIST</a>);
    <a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>&lt;u64,<a href="bfc_dao.md#0xc8_bfc_dao_BFCDaoAction">BFCDaoAction</a>&gt;(&<b>mut</b> dao.action_record,&actionId);
}
</code></pre>
...
<pre><code><b>public</b> (<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_remove_proposal">remove_proposal</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,_: &BFCDaoManageKey, proposalId: u64){
    <b>let</b> size=<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_size">vec_map::size</a>(&dao.proposal_record);
    ...
    <b>assert</b>!(<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>&lt;u64,<a href="bfc_dao.md#0xc8_bfc_dao_ProposalInfo">ProposalInfo</a>&gt;(&dao.proposal_record,&proposalId),<a href="bfc_dao.md#0xc8_bfc_dao_ERR_PROPOSAL_ID_MISMATCH">ERR_PROPOSAL_ID_MISMATCH</a>);
    <a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>&lt;u64,<a href="bfc_dao.md#0xc8_bfc_dao_ProposalInfo">ProposalInfo</a>&gt;(&<b>mut</b> dao.proposal_record,&proposalId);
}
</code></pre>
...
<pre><code><b>include</b> <a href="bfc_dao.md#0xc8_bfc_dao_NewDaoConfigParamSchema">NewDaoConfigParamSchema</a>;
</code></pre>
...
<pre><code><b>pragma</b> aborts_if_is_partial = <b>true</b>;
<b>aborts_if</b> <b>false</b>;
<b>let</b> <a href="../../../.././build/Sui/docs/bfc.md#0x2_bfc">bfc</a> =  payment.<a href="../../../.././build/Sui/docs/balance.md#0x2_balance">balance</a>;
<b>let</b> count = <a href="../../../.././build/Sui/docs/balance.md#0x2_balance_value">balance::value</a>(<a href="../../../.././build/Sui/docs/bfc.md#0x2_bfc">bfc</a>);
<b>aborts_if</b> count &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_NEW_PROPOSE_COST">MIN_NEW_PROPOSE_COST</a>;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_cast_vote">cast_vote</a>(
    dao:  &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    ...
    {
        <b>let</b> state = <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(proposal,<a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>);
    ...
    <b>let</b> vote_amount = <a href="bfc_dao_voting_pool.md#0xc8_voting_pool_voting_bfc_amount">voting_pool::voting_bfc_amount</a>(&<a href="../../../.././build/Sui/docs/coin.md#0x2_coin">coin</a>);
    {
...
<b>aborts_if</b> <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(proposal.proposal,current_time) != <a href="bfc_dao.md#0xc8_bfc_dao_ACTIVE">ACTIVE</a>;
<b>aborts_if</b> <a href="../../../.././build/Sui/docs/coin.md#0x2_coin">coin</a>.principal.value == 0 || <a href="../../../.././build/Sui/docs/coin.md#0x2_coin">coin</a>.principal.value &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_VOTE_AMOUNT">MAX_VOTE_AMOUNT</a>;
<b>aborts_if</b> <a href="../../../.././build/Sui/docs/coin.md#0x2_coin">coin</a>.principal.value &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_VOTING_THRESHOLD">MIN_VOTING_THRESHOLD</a>;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_change_vote">change_vote</a>(
    dao:  &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
...
<b>aborts_if</b> my_vote.agree == <b>false</b> && proposal.proposal.for_votes + my_vote.vote.principal.value &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_VOTE_AMOUNT">MAX_VOTE_AMOUNT</a>;
<b>aborts_if</b> my_vote.agree == <b>true</b> && proposal.proposal.for_votes &lt; my_vote.vote.principal.value;
<b>aborts_if</b> my_vote.agree == <b>true</b> && proposal.proposal.against_votes + my_vote.vote.principal.value &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_VOTE_AMOUNT">MAX_VOTE_AMOUNT</a>;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_revoke_vote">revoke_vote</a>(
    dao:  &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    proposal: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
    my_vote:  <a href="bfc_dao.md#0xc8_bfc_dao_Vote">Vote</a>,
    voting_power: u64,
    <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>: & Clock,
    ctx: &<b>mut</b> TxContext,
){
...
<b>aborts_if</b> voting_power &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_VOTING_THRESHOLD">MIN_VOTING_THRESHOLD</a> || voting_power &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_VOTE_AMOUNT">MAX_VOTE_AMOUNT</a>;
...
<b>aborts_if</b> my_vote.vote.principal.value - voting_power &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_VOTING_THRESHOLD">MIN_VOTING_THRESHOLD</a>;
<b>aborts_if</b> ctx.ids_created + 1 &gt; MAX_U64;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_unvote_votes">unvote_votes</a>(
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_has_vote">has_vote</a>(
    vote: &<a href="bfc_dao.md#0xc8_bfc_dao_Vote">Vote</a>,
    proposal: &<a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
): bool  {
    <a href="../../../.././build/Sui/docs/event.md#0x2_event_emit">event::emit</a>(
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_queue_proposal_action">queue_proposal_action</a>(
    dao:  &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    proposal: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
    <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>: & Clock,
    ...
    //<b>let</b> sender = <a href="../../../.././build/Sui/docs/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
        ...
        <b>assert</b>!(
            <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(proposal, <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>) == <a href="bfc_dao.md#0xc8_bfc_dao_AGREED">AGREED</a>,
...
<b>aborts_if</b> <b>false</b>;
<b>let</b> current_time = <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>.timestamp_ms;
<b>aborts_if</b> <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(proposal.proposal,current_time) != <a href="bfc_dao.md#0xc8_bfc_dao_AGREED">AGREED</a>;
<b>aborts_if</b> proposal.proposal.action_delay &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_TIME_PERIOD">MAX_TIME_PERIOD</a>;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_extract_proposal_action">extract_proposal_action</a>(
    ...
    <b>assert</b>!(
        <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(proposal, <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>) == <a href="bfc_dao.md#0xc8_bfc_dao_EXECUTABLE">EXECUTABLE</a>,
        (<a href="bfc_dao.md#0xc8_bfc_dao_ERR_PROPOSAL_STATE_INVALID">ERR_PROPOSAL_STATE_INVALID</a>),
    );
...
<pre><code><b>aborts_if</b> <b>false</b>;
<b>let</b> current_time = <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>.timestamp_ms;
<b>aborts_if</b> <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(proposal.proposal,current_time) != <a href="bfc_dao.md#0xc8_bfc_dao_EXECUTABLE">EXECUTABLE</a>;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(proposal: &<a href="bfc_dao.md#0xc8_bfc_dao_Proposal">bfc_dao::Proposal</a>, <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Sui/docs/clock.md#0x2_clock_Clock">clock::Clock</a>): u8
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(
    proposal: &<a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
    <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>: & Clock,
): u8  {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_proposal_info">proposal_info</a>(
    proposal: &<a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
) : (u64, u64) {
    <a href="../../../.././build/Sui/docs/event.md#0x2_event_emit">event::emit</a>(
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_voting_delay">voting_delay</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>): u64 {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_voting_period">voting_period</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>): u64 {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_voting_quorum_rate">voting_quorum_rate</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>): u8 {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_min_action_delay">min_action_delay</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>): u64 {
...
<pre><code><b>aborts_if</b> <b>false</b>;
<b>include</b> <a href="bfc_dao.md#0xc8_bfc_dao_NewDaoConfigParamSchema">NewDaoConfigParamSchema</a>;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_voting_delay">set_voting_delay</a>(
    dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    value: u64,
) {
...
<b>aborts_if</b> value &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_TIME_PERIOD">MAX_TIME_PERIOD</a>;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_voting_period">set_voting_period</a>(
    dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    value: u64,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_voting_quorum_rate">set_voting_quorum_rate</a>(
    dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    value: u8,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_min_action_delay">set_min_action_delay</a>(
    dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    value: u64,
) {
...
<pre><code><b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_admins">set_admins</a>(new_admins: <a href="">vector</a>&lt;<b>address</b>&gt;, ctx: &<b>mut</b> <a href="../../../.././build/Sui/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>pragma</b> aborts_if_is_partial = <b>true</b>;
<b>aborts_if</b> <a href="_length">vector::length</a>(new_admins) &gt; <a href="bfc_dao.md#0xc8_bfc_dao_MAX_ADMIN_COUNT">MAX_ADMIN_COUNT</a> || <a href="_length">vector::length</a>(new_admins) == 0;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_create_stake_manager_key">create_stake_manager_key</a>(payment: <a href="../../../.././build/Sui/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="../../../.././build/Sui/docs/bfc.md#0x2_bfc_BFC">bfc::BFC</a>&gt;, ctx: &<b>mut</b> <a href="../../../.././build/Sui/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_create_stake_manager_key">create_stake_manager_key</a>( payment: Coin&lt;BFC&gt;,
                              ctx: &<b>mut</b> TxContext){
    ...
    <a href="bfc_dao_manager.md#0xc8_bfc_dao_manager_create_stake_key">bfc_dao_manager::create_stake_key</a>(sender,<a href="../../../.././build/Sui/docs/balance.md#0x2_balance">balance</a>, ctx);
}
</code></pre>
...
<pre><code><b>aborts_if</b> <b>false</b>;
<b>aborts_if</b> payment.<a href="../../../.././build/Sui/docs/balance.md#0x2_balance">balance</a>.value &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_STAKE_MANAGER_KEY_COST">MIN_STAKE_MANAGER_KEY_COST</a>;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_unstake_manager_key">unstake_manager_key</a>(key: BFCDaoManageKey,
                        token: ManagerKeyBfc,
                        ctx: &<b>mut</b> TxContext){
...
<pre><code><b>aborts_if</b> <b>false</b>;
<b>aborts_if</b> ctx.ids_created + 1 &gt; MAX_U64;
<b>aborts_if</b> <a href="../../../.././build/Sui/docs/coin.md#0x2_coin">coin</a>.<a href="../../../.././build/Sui/docs/balance.md#0x2_balance">balance</a>.value &lt; <a href="bfc_dao.md#0xc8_bfc_dao_MIN_VOTING_THRESHOLD">MIN_VOTING_THRESHOLD</a>;
</code></pre>
...
<pre><code><b>aborts_if</b> <b>false</b>;
<b>aborts_if</b> pool_id(voting_bfc) != <a href="../../../.././build/Sui/docs/object.md#0x2_object_id">object::id</a>(dao.<a href="bfc_dao_voting_pool.md#0xc8_voting_pool">voting_pool</a>);
<b>aborts_if</b> ctx.ids_created + 1 &gt; MAX_U64;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_destroy_terminated_proposal">destroy_terminated_proposal</a>(
    dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>,
    _: &BFCDaoManageKey,
    proposal:  &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Proposal">Proposal</a>,
    <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>: & Clock,
    ...
    <b>let</b> proposal_state = <a href="bfc_dao.md#0xc8_bfc_dao_proposal_state">proposal_state</a>(proposal,<a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>);
    <b>assert</b>!(
    ...
    <b>assert</b>!(<a href="../../../.././build/Sui/docs/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&dao.proposal_record, &proposal.proposal.pid), (<a href="bfc_dao.md#0xc8_bfc_dao_ERR_PROPOSAL_NOT_EXIST">ERR_PROPOSAL_NOT_EXIST</a>));
...
<b>aborts_if</b> <b>false</b>;
<b>let</b> current_time = <a href="../../../.././build/Sui/docs/clock.md#0x2_clock">clock</a>.timestamp_ms;
<b>aborts_if</b> <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(proposal.proposal,current_time) != <a href="bfc_dao.md#0xc8_bfc_dao_DEFEATED">DEFEATED</a>
    && <a href="bfc_dao.md#0xc8_bfc_dao_judge_proposal_state">judge_proposal_state</a>(proposal.proposal,current_time) != <a href="bfc_dao.md#0xc8_bfc_dao_EXTRACTED">EXTRACTED</a>;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bfc_dao.md#0xc8_bfc_dao_set_current_status_into_dao">set_current_status_into_dao</a>(dao: &<b>mut</b> <a href="bfc_dao.md#0xc8_bfc_dao_Dao">Dao</a>, proposalInfo : &<a href="bfc_dao.md#0xc8_bfc_dao_ProposalInfo">ProposalInfo</a>, curProposalStatus: u8) {
