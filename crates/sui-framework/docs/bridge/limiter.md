...
<pre><code><b>use</b> <a href="../bfc_system/busd.md#bfc_system_busd">bfc_system::busd</a>;
...
<pre><code><b>const</b> <a href="../bridge/limiter.md#bridge_limiter_DEFAULT_MAX_MINT_BUSD_LIMIT">DEFAULT_MAX_MINT_BUSD_LIMIT</a>: u64 = 100000000000000;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/limiter.md#bridge_limiter_get_available_claim_amount">get_available_claim_amount</a>&lt;T&gt;(
    ...
    <b>let</b> available_amount=((route_limit_adjusted-total_adjusted) / price) <b>as</b> u64;
    <b>return</b> <b>if</b> (type_name::get&lt;T&gt;() == type_name::get&lt;BUSD&gt;()){
        <b>let</b> busd_mint_limit=self.<a href="../bridge/limiter.md#bridge_limiter_get_mint_busd_max_limit">get_mint_busd_max_limit</a>();
