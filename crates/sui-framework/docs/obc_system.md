...
-  [Function `get_obc_amount`](#0xc8_obc_system_get_obc_amount)
...
<a name="0xc8_obc_system_get_obc_amount"></a>

## Function `get_obc_amount`



<pre><code><b>public</b> entry <b>fun</b> <a href="obc_system.md#0xc8_obc_system_get_obc_amount">get_obc_amount</a>(self: &<a href="obc_system.md#0xc8_obc_system_ObcSystemState">obc_system::ObcSystemState</a>): u64
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="obc_system.md#0xc8_obc_system_get_obc_amount">get_obc_amount</a>(
self: &<a href="obc_system.md#0xc8_obc_system_ObcSystemState">ObcSystemState</a>): u64
{
    <b>let</b> inner_state = <a href="obc_system.md#0xc8_obc_system_load_system_state">load_system_state</a>(self);
    <a href="obc_system_state_inner.md#0xc8_obc_system_state_inner_get_obc_amount">obc_system_state_inner::get_obc_amount</a>(inner_state)
}
</code></pre>
