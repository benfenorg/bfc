...
<dt>
<code>safe_mode_storage_rewards: <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>safe_mode_computation_rewards: <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_create">create</a>(
    ...
    <b>let</b> init_gas_coins_map = <a href="_empty">vec_map::empty</a>&lt;<b>address</b>, GasCoinEntity&gt;();
    <b>let</b> init_coin = <a href="_from_balance">coin::from_balance</a>(initial_storage_fund, ctx);
    <b>let</b> coin_id_address = <a href="_id_address">object::id_address</a>(&init_coin);
    <a href="_insert">vec_map::insert</a>(&<b>mut</b> init_gas_coins_map, coin_id_address, <a href="gas_coin_map.md#0x3_gas_coin_map_new_default_entity">gas_coin_map::new_default_entity</a>(coin_id_address));
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_request_add_stake">request_add_stake</a>(self: &<b>mut</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, stake: <a href="_Coin">coin::Coin</a>&lt;<a href="_OBC">obc::OBC</a>&gt;, validator_address: <b>address</b>, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedObc">staking_pool::StakedObc</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_request_add_stake_mul_coin">request_add_stake_mul_coin</a>(self: &<b>mut</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, stakes: <a href="">vector</a>&lt;<a href="_Coin">coin::Coin</a>&lt;<a href="_OBC">obc::OBC</a>&gt;&gt;, stake_amount: <a href="_Option">option::Option</a>&lt;u64&gt;, validator_address: <b>address</b>, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedObc">staking_pool::StakedObc</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_request_withdraw_stake">request_withdraw_stake</a>(self: &<b>mut</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, staked_sui: <a href="staking_pool.md#0x3_staking_pool_StakedObc">staking_pool::StakedObc</a>, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, new_epoch: u64, next_protocol_version: u64, storage_reward: <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;, computation_reward: <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;, storage_rebate_amount: u64, non_refundable_storage_fee_amount: u64, storage_fund_reinvest_rate: u64, reward_slashing_rate: u64, epoch_start_timestamp_ms: u64, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_init_exchange_gas_pool">init_exchange_gas_pool</a>(
    ...
    <a href="exchange_inner.md#0x3_exchange_inner_add_obc">exchange_inner::add_obc</a>(&<b>mut</b> self.exchange_gas_coin_pool, <a href="">coin</a>)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_exchange_gas">exchange_gas</a>(self: &<b>mut</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, <a href="">stable</a>: <a href="_Coin">coin::Coin</a>&lt;<a href="_STABLE">stable::STABLE</a>&gt;, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_exchange_gas">exchange_gas</a>(
    ...
    <b>let</b> rate = <a href="gas_coin_map.md#0x3_gas_coin_map_requst_get_exchange_rate">gas_coin_map::requst_get_exchange_rate</a>&lt;STABLE&gt;(&self.<a href="gas_coin_map.md#0x3_gas_coin_map">gas_coin_map</a>, &<a href="">stable</a>);
    <a href="exchange_inner.md#0x3_exchange_inner_request_exchange_gas">exchange_inner::request_exchange_gas</a>(rate, &<b>mut</b> self.exchange_gas_coin_pool, <a href="">stable</a>, ctx)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_gas_coin_rate">gas_coin_rate</a>(self: &<a href="sui_system_state_inner.md#0x3_sui_system_state_inner_SuiSystemStateInnerV2">sui_system_state_inner::SuiSystemStateInnerV2</a>, <a href="">stable</a>: &<a href="_Coin">coin::Coin</a>&lt;<a href="_STABLE">stable::STABLE</a>&gt;): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_gas_coin_rate">gas_coin_rate</a>(
    ...
    <a href="gas_coin_map.md#0x3_gas_coin_map_requst_get_exchange_rate">gas_coin_map::requst_get_exchange_rate</a>&lt;STABLE&gt;(&self.<a href="gas_coin_map.md#0x3_gas_coin_map">gas_coin_map</a>, <a href="">stable</a>)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_extract_coin_balance">extract_coin_balance</a>(coins: <a href="">vector</a>&lt;<a href="_Coin">coin::Coin</a>&lt;<a href="_OBC">obc::OBC</a>&gt;&gt;, amount: <a href="_Option">option::Option</a>&lt;u64&gt;, ctx: &<b>mut</b> <a href="_TxContext">tx_context::TxContext</a>): <a href="_Balance">balance::Balance</a>&lt;<a href="_OBC">obc::OBC</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="sui_system_state_inner.md#0x3_sui_system_state_inner_extract_coin_balance">extract_coin_balance</a>(coins: <a href="">vector</a>&lt;Coin&lt;OBC&gt;&gt;, amount: <a href="_Option">option::Option</a>&lt;u64&gt;, ctx: &<b>mut</b> TxContext): Balance&lt;OBC&gt; {
