...
use sui_types::sui_system_state::PoolStableTokenExchangeRate;
...
use sui_types::sui_system_state::sui_system_state_summary::BagSummary;
        ...
        for (pool_id, stakes) in pools {
            ...
            for (stake, exists) in stakes {
                ...
                delegations.push(Stake {
                    ...
                    stake_request_epoch: stake.activation_epoch().checked_sub(1).unwrap_or(0),
