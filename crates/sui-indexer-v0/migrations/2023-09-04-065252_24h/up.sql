...
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS transact_bfc BIGINT NOT NULL DEFAULT 0;
ALTER TABLE checkpoints ADD COLUMN IF NOT EXISTS total_transact_bfc BIGINT NOT NULL DEFAULT 0,
...
(
    ...
    total_transact_bfc      BIGINT NOT NULL,    -- How much BFCs were transacted in this minute
...
SELECT (SELECT SUM(total_transact_bfc)::varchar FROM network_segment_metrics WHERE segment_started_at > extract(epoch from current_timestamp)::BIGINT - 86400)
               AS volume_24h,
