...
use sui_bridge::types::{
    ...
    AddTokenOnTokenListAction, AddTokensOnEvmAction, AddTokensOnSuiAction, AssetPriceUpdateAction,
    BlocklistCommitteeAction, BlocklistType, EmergencyAction, EmergencyActionType,
    EvmContractUpgradeAction, LimitUpdateAction, RemoveExternalCoinAdminAction,
    RemoveExternalCoinTargetAction, RemoveExternalCoinWitnessAction, RemoveTokenOnTokenListAction,
...
pub fn select_contract_address(
    ...
    match cmd {
        ...
        GovernanceClientCommands::UpdateRefundAdmin { .. } => {
            config.eth_bridge_config_proxy_address
        }
        GovernanceClientCommands::UpdateFastPathLimit { .. } => {
            config.eth_bridge_config_proxy_address
        }
