...
pub fn hfe_ops_encode_data_v1(context: &mut NativeContext,
                              _ty_args: Vec<Type>,
...
pub fn hfe_ops_compare_value1_and_value2_v1(
    context: &mut NativeContext,
    _ty_args: Vec<Type>,
    mut args: VecDeque<Value>,
) -> PartialVMResult<NativeResult>{
...
pub fn hfe_ops_compare_value_v1(
    context: &mut NativeContext,
    _ty_args: Vec<Type>,
    mut args: VecDeque<Value>,
) -> PartialVMResult<NativeResult>{
